        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="panel-body" style="background:white;">
                    <h4 style="margin: 0;padding: 0;border-bottom: 1px solid #ECF0F1;padding-bottom: 0.6em;margin-bottom: 0.6em;"><i class="fa fa-edit" aria-hidden="true"></i> Supporting Documents</h4>
                </div>
                <div class="widget-container " style="min-height: 1em; margin-top:-25px;">
            ...
            <div class="col-md-4">
                <div class="panel-body" style="background:white;">
                    <h4 style="margin: 0;padding: 0;border-bottom: 1px solid #ECF0F1;padding-bottom: 0.6em;margin-bottom: 0.6em;"><i class="fa fa-edit" aria-hidden="true"></i> Upload your documents here</h4>
                </div>
                <div class="widget-container" style="min-height: 1em; margin-top:-25px;">
                    <div class="widget-content padded">
